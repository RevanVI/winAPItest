...
LRESULT CALLBACK MainWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	p0(1, 0) = 1; p0(1, 1) = 2; p0(1, 2) = 0;
	p0(2, 0) = 3; p0(2, 1) = 2; p0(2, 2) = 0;
	p0(3, 0) = 2; p0(3, 1) = 0; p0(3, 2) = 0;
	p0(4, 0) = 4; p0(4, 1) = 2; p0(4, 2) = 0;
	//p0(5, 0) = 12; p0(5, 1) = 0;
